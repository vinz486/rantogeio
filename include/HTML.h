...
<body>
        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group">
                             <button type="submit" formaction="/calibrate-hour" formmethod="post">Hour</button>
                        </div>
                        <div class="form-group">
                            <button type="submit" formaction="/calibrate-minute" formmethod="post">Minute</button>
                        </div>
                        <div class="form-group">
                            <button type="submit" formaction="/calibrate-end" formmethod="post">Stop</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="card">
                ...
                <div id="offsets-container">
                    ...
                    <button type="button" onclick="showOffsetModal('hour')">Add Hour Offset</button>

                    <h3>Minute Offsets</h3>
                    <ul id="minute-offsets-list"></ul>
                    <button type="button" onclick="showOffsetModal('minute')">Add Minute Offset</button>

                    <div class="form-group" style="margin-top: 1rem;">
                        <button type="button" onclick="saveAllOffsets()">Save All Offsets</button>
                    </div>
                </div>
            </div>
    ...
    <div id="offset-modal">
        <div class="modal-content">
            ...
            <div class="form-row">
                <div class="form-group">
                    <button type="button" onclick="saveOffset()">Save</button>
                </div>
                <div class="form-group">
                    <button type="button" onclick="hideOffsetModal()">Cancel</button>
                </div>
            </div>
        </div>
    </div>
